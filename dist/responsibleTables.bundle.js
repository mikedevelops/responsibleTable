(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.ResponsibleTables = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/*
    ...
    _createClass(ResponsibleTables, [{
        ...
        value: function init() {
            ...
            this.originalTables.map(function (table, index) {
                ...
                var _tableData$index = _this.tableData[index];
                var currentWidth = _tableData$index.currentWidth;
                var container = _tableData$index.container;

                // set table min width if we can

                if (currentWidth > container.width) {
                    _this.tableData[index].minWidth = currentWidth;
                }

                var minWidth = _this.tableData[index].minWidth;
        ...
        value: function refresh() {
            ...
            this.originalTables.map(function (table, index) {
                var node = _this2.tableData[index].node;

                // get current width of table

                _this2.tableData[index].currentWidth = node.getBoundingClientRect().width;

                console.log('table current width: ', _this2.tableData[index].currentWidth);
                ...
                var _tableData$index2 = _this2.tableData[index];
                var currentWidth = _tableData$index2.currentWidth;
                var minWidth = _tableData$index2.minWidth;
                var isResponsible = _tableData$index2.isResponsible;

                // update min width

                if (currentWidth > _this2.tableData[index].container.width) {
                    _this2.tableData[index].minWidth = currentWidth;
                }

                // to build or not to build...
                if (minWidth > _this2.tableData[index].container.width) {
                    _this2.build(table, index);
                } else if (minWidth !== 0 && minWidth < _this2.tableData[index].container.width && isResponsible) {
        ...
        value: function build(table, tableIndex) {
            ...
            if (!this.tableData[tableIndex].hasChanged) {
                var rows = this.tableData[tableIndex].rows;

                var innerTableHTML = this.buildFirstRow(table);
                var tableHTML = this.regex.tableElement.exec(table.outerHTML)[0];

                // remove first row as we've already dealt with that
                rows.nodes.shift();

                // loop through rows excluding the first and build out the data
                rows.nodes.map(function (row, index) {
                    innerTableHTML += _this3.buildTableData(tableIndex, index);
                });
        ...
        **/
        ...
        value: function getTableHeadings(table, index) {
            ...
            this.tableData[index].columns.nodes.map(function (column, columnIndex) {
        ...
        key: 'buildFirstRow',
        value: function buildFirstRow(table) {
            var firstCellHTML = table.querySelector('tr').children[0].outerHTML;

            firstCellHTML = this.replaceColspan(firstCellHTML, 2);

            // split element on opening tag
            var cellDataList = firstCellHTML.split(this.regex.tableCell);
        ...
        key: 'buildTableData',
        value: function buildTableData(tableIndex, rowIndex) {
            var _this4 = this;

            var _tableData$tableIndex = this.tableData[tableIndex];
            var columns = _tableData$tableIndex.columns;
            var headings = _tableData$tableIndex.headings;

            var cells = [].slice.call(this.tableData[tableIndex].rows.nodes[rowIndex].children);
            var firstCellHTML = cells[0].outerHTML;
            var tableDataHTML = '';
            ...
            columns.nodes.map(function (column, index) {
                if (index) {
                    var row = '<tr><td>' + headings.titles[index] + '</td>';
                    var cell = cells[index].outerHTML;

                    row = _this4.addCellClass(row, _this4.options.columnHeadingClass);
                    cell = _this4.addCellClass(cell, _this4.options.tableDataClass);
                    row += cell + '</tr>';
                    tableDataHTML += row;
                }
            });
            ...
            if (index === null) {
                this.originalTables.map(function (table, index) {
                    if (_this5.tableData[index].isResponsible) {
                        ...
                        _this5.tableData[index].node = [].slice.call(document.querySelectorAll(_this5.options.tableSelector))[index];
                    } else {
        ...
        key: 'replaceColspan',
        value: function replaceColspan(string, colspan) {
            if (this.regex.collspan.exec(string)) {
                string = string.replace(this.regex.collspan, 'colspan="' + colspan + '"');
            } else {
                var splitCell = string.split(this.regex.tableCell);
        ...
        key: 'addCellClass',
        value: function addCellClass(string, className) {
            var classList = this.regex.className.exec(string);

            if (classList !== null) {
                var initialClass = classList[1];
...
},{"classlist-polyfill":1,"lodash.debounce":2,"lodash.defaultsDeep":3}]},{},[4])(4)
});
